...

{
  ...
  "propagation": {
    "1": {
      "status": "fired | not_fired_this_session",
      "result": "propagated | clean | corrected_in_memo | ambiguous | not_applicable",
      "evidence_quote": "exact memo sentence or null",
      "positive_challenge_flag": "true or false",
    ...
    "5": {
      "status": "fired | not_fired_this_session",
      "shopify_treatment": "accepted_with_nuance | accepted_without_nuance | dismissed | not_mentioned",
  ...
  "memo_quality": {
    "factual_correctness": {
      "score": "number",
      "evidence": "one sentence citing specific example that drove this score"
    },
    "reasoning_linkage": {
      "score": "number",
      "evidence": "one sentence citing specific example"
    },
    "tradeoff_handling": {
      "score": "number",
      "evidence": "one sentence citing specific example"
    ...
    "recommendation_calibration": {
      "score": "number",
      "recommendation_found": "Pass | Invest | Invest at revised terms | unclear | none",
      "evidence": "one sentence citing specific example"
    }
  },
  "flags": [
    "string — anomalies, evaluator-directed text detected, style-over-substance signals, or other issues"
  ]
}
