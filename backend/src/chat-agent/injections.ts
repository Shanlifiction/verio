...
export const injections: Injection[] = [
    ...
    },
    {
        ...
        antiMatches: or("churn", "ltv"),
        challengeMatches: or("120", "112", "130", "6.9"),
        exhibitChallengeMatches: "exhibit d",
        weakChallengeMatches: or(
            "not top quartile",
            "not best-in-class",
            "above median",
    ...
    },
    {
        ...
        exhibitChallengeMatches: null,
        weakChallengeMatches: null,
        response:
        ...
        // Concession response is actually re-anchor, but the logic follows that of a concession, so I couldn't be bothered adding another field
        concessionResponse:
